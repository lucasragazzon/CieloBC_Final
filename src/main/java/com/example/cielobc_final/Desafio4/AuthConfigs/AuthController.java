package com.example.cielobc_final.Desafio4.AuthConfigs;
...
public class AuthController {
    ...
    public ResponseEntity<String> login(HttpServletRequest request, @RequestParam("username") String username,
        ...
        try {
            ...
            return new ResponseEntity<>("Oops, Something went wrong! Please try again", HttpStatus.INTERNAL_SERVER_ERROR);
        }

        return new ResponseEntity<>("User " + username + " connected successfully!", HttpStatus.OK);
    }
    ...
    public ResponseEntity<String> register(@RequestParam("username") String username,
        ...
        return new ResponseEntity<>("User " + username + " successfully created!", HttpStatus.OK);
    }
}